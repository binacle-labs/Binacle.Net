...
| Path | What it is |
|---|---|
| `BischoffSuite/`, `CustomProblems/` | One `Scenarios` class per set - its keys, every scenario by name, and the distinct bins |
...
`../custom-problems`, `../demo-samples`) and is linked in by the csproj; edit it there.
