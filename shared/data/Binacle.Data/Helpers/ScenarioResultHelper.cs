...
namespace Binacle.Data.Helpers;

public static class ScenarioResultHelper
{
	private static AlgorithmResult ParseFromCompactString(string compactString)
	{
	...
	public static ScenarioResult ParseFromMap(IReadOnlyDictionary<string, string> byAlgorithm)
	{
		var parsed = new Dictionary<Algorithm, AlgorithmResult>();
		...
		return new ScenarioResult(parsed);
	}
