...
`<slice>/results/benchmarks/baseline/<family>/` for a class's first kept run, or `<date>/<family>/` after,
renamed to the class, with a line added to that folder's README.
