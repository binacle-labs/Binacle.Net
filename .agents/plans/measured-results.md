...
| 8 | [08-lib-packing-efficiency](measured-results/08-lib-packing-efficiency.md) | one run, many views: the runner, the builder, the four lib files | `test -f lib/results/algorithm-wins.md` |
...
| 10 | [10-vipaq-encoded-size](measured-results/10-vipaq-encoded-size.md) | a JSON encoder joins protobuf; the ViPaq runner and builder, `encoded-size.md` with its JSON column, the README | `test -f vipaq/results/encoded-size.md` |
