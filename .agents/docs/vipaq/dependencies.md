...
| `ReportPathRoundTripCheck` | all 2,316 packs at natural widths through the kernel's `ViPaqEncoder`, the exact encoder the reports use, each codec × both layouts |
