...
- **License:** AGPL-3.0-only for the code, CC-BY-4.0 for the content. The wire formats are Apache-2.0 and the samples are MIT - see [NOTICE](https://github.com/binacle-labs/Binacle.Net/blob/main/NOTICE)
