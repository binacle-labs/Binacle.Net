...
The files and settings themselves are on the [Configuration]({% vlink /configuration/index.md %}) pages.
...
The exact structure is on the [Configuration]({% vlink /configuration/index.md %}) pages.
