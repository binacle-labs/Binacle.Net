...
title: V3
description: >-
  The stable Binacle.Net API. Fit and pack items into preset or custom bins, choose the algorithm, and get the
  result as JSON or a ViPaq string.
nav:
  parent: API
  order: 3
  icon: ✅
  ...
  "data": [
    ...
    },
    {
      ...
      "fittedItems": [
        ...
        { "id": "box_3", "length": 12, "width": 10, "height": 15 },
        { "id": "box_1", "length": 2, "width": 5, "height": 10 },
        { "id": "box_1", "length": 2, "width": 5, "height": 10 }
      ],
      "unfittedItems": [],
...
```json
{
  ...
  "data": [
    ...
    },
    {
      ...
      "packedItemsVolumePercentage": 100,
      "packedBinVolumePercentage": 7.92,
      "viPaqData": "AAAEABQoPAwPCgAAAAwKDwAPAAIFCgwAAAIFCgAACg=="
    }
  ]
}
```
