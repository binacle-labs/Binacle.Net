...
title: V4
description: >-
  The experimental Binacle.Net API: 16 endpoints organised by the answer you want. It can change at any time, so
  use V3 for anything you keep.
nav:
  parent: API
  order: 4
  icon: 🧪
...
> This API version is experimental and can change at any time - a minor release may change it.
