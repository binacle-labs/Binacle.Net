...
title: Release Notes
description: >-
  What changed in this line of Binacle.Net, newest release first, with every release on one page. v2.0.0
  removed the V1 endpoints and rewrote the Service Module; nothing after it breaks an integration.
nav:
  order: 2
  icon: 🛠️
---

Release notes for the **v2.x** line, newest release first. Every release in this line is on this page.

> Coming from v1? v2.0.0 breaks integrations - its section below has the migration guide. Nothing after it does.
{: .block-note}
