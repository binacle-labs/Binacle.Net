...
title: V2
description: >-
  The V2 API as documented for Binacle.Net. Fit and pack by preset or custom bins, with FFD fixed as the
  algorithm.
nav:
  parent: API
  order: 2
  icon: ⚖️
swagger: 'v2'  # the Swagger UI page and this button were added in 2.1.0; a 2.0.x image has neither
---
...
🔍 Learn more: [Core Concepts]({% vlink /core-concepts.md %})
