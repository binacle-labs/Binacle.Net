...
title: V3
description: >-
  The V3 API as documented for Binacle.Net. Fit and pack by preset or custom bins, choose the algorithm,
  and get ViPaq packing results.
nav:
  parent: API
  order: 3
  icon: 🧪
swagger: 'v3'  # the Swagger UI page and this button were added in 2.1.0; a 2.0.x image has neither
---
