...
and keeping the requests you send small.

---

## 📌 Integration Essentials

- Structure product dimensions as integer values (centimeters are highly recommended)
...
- Set bin presets - see [Presets]({% vlink /configuration/core/presets.md %}).
