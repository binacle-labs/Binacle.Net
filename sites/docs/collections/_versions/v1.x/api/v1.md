...
title: V1
description: >-
  The V1 API in Binacle.Net. Fitting only: it finds the smallest bin that holds your items. Deprecated,
...
🔍 Learn more: [Core Concepts]({% vlink /core-concepts.md %}#-fitting)
