...
The API itself, the presets, and the switch for Swagger UI.
...
Rate limiting, user management and JWT authentication, for running Binacle.Net as a public service.
