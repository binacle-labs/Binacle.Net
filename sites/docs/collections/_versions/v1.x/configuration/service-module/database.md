...
title: Database
description: >-
  The Service Module in Binacle.Net keeps user data in Azure Tables. The ConnectionStrings.json settings
...
[Configuration > Connection String Fallbacks]({% vlink /configuration/index.md %}#-connection-string-fallbacks) section.
