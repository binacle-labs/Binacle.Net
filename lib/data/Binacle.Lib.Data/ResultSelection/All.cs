...
public static class All
{
	...
	static All()
	{
		...
		[
			new MultipleScenarioCollectionsProvider(BestAlgorithm.Scenarios.Keys),
			new MultipleScenarioCollectionsProvider(BestBin.Scenarios.Keys),
			new MultipleScenarioCollectionsProvider(SmallestBin.Scenarios.Keys),
		];
